...
// Skeleton Loader Component with Updated Colors
const ChatSkeleton = () => {
  return (
    <div className="flex h-screen bg-white dark:bg-slate-900">
      ...
      <div className="w-80 bg-slate-50 dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 p-4">
        ...
        {/* New Chat Button */}
        <div className="mb-6">
          <div className="h-10 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg animate-pulse"></div>
        </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex justify-start">
              <div className="flex items-start space-x-3 max-w-md">
                <div className="h-8 w-8 bg-gradient-to-r from-emerald-500 to-green-500 rounded-full animate-pulse flex-shrink-0"></div>
            ...
            <div className="flex justify-end">
              <div className="flex items-start space-x-3 max-w-md">
                <div className="bg-slate-100 dark:bg-slate-700 rounded-xl p-4 shadow-sm border border-slate-200 dark:border-slate-600">
                  <div className="space-y-2">
                    <div className="h-4 w-52 bg-slate-300 dark:bg-slate-600 rounded animate-pulse"></div>
                    <div className="h-4 w-48 bg-slate-300 dark:bg-slate-600 rounded animate-pulse"></div>
                  </div>
                </div>
        ...
        <div className="border-t border-slate-200 dark:border-slate-700 p-4 bg-white dark:bg-slate-900">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-end space-x-3">
              <div className="flex-1 h-12 bg-slate-100 dark:bg-slate-800 rounded-xl animate-pulse border border-slate-200 dark:border-slate-700"></div>
              <div className="h-12 w-12 bg-gradient-to-r from-emerald-500 to-green-500 rounded-xl animate-pulse flex items-center justify-center">
                <Send className="h-5 w-5 text-white opacity-70" />
              </div>
            </div>
          </div>
        </div>
