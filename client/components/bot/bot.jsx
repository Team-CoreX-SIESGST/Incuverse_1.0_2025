...
export default function AshaCentersMap() {
  ...
  return (
    <div className="relative bg-slate-50 dark:bg-slate-950 py-16 sm:py-24 min-h-screen">
      <Navbar />
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-slate-900/5 dark:bg-slate-100/5 ring-1 ring-inset ring-slate-900/10 dark:ring-slate-100/10 mb-6 backdrop-blur-lg">
            ...
            <span className="text-sm font-medium text-slate-800 dark:text-slate-200">
              {t("AshaCenters.nationwideNetwork")}
            </span>
          </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg ring-1 ring-slate-900/5 dark:ring-slate-100/10 p-6 h-fit sticky top-24">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold text-slate-900 dark:text-white">
                  {t("AshaCenters.centersList")} ({ASHA_CENTERS.length})
                </h3>
                {selectedCenter && (
                  <button
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-xs text-slate-500 dark:text-slate-400">
                          <div className="flex items-center gap-1">
                            ...
                            <span>
                              {center.workers} {t("AshaCenters.workers")}
                            </span>
                          </div>
                          <div className="flex items-center gap-1">
                            <Activity className="w-3 h-3" />
                            <span>
                              {center.patients} {t("AshaCenters.patients")}
                            </span>
                          </div>
                        </div>
                      </div>
        ...
        >
          {[
            { value: "10K+", label: t("AshaCenters.stats.ashaWorkers") },
            { value: "500+", label: t("AshaCenters.stats.centers") },
            { value: "25+", label: t("AshaCenters.stats.statesCovered") },
            { value: "1M+", label: t("AshaCenters.stats.patientsServed") },
          ].map((stat) => (
